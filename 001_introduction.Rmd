...
$$\begin{split}
  ...
  & \Longrightarrow -a > 0 & \text{ Exercises I.33 2}
  \end{split}$$
...
$$\begin{split}
  ...
  & \Longrightarrow (c + d) + (-(a + b)) \in \mathbb{R}^+ & \text{ Exercises I.33 5} \\
  & \Longrightarrow (c + d) - (a + b) \in \mathbb{R}^+ & \text{ Theorem I.3} \\
...
Fourth, $-1 < 0$ by **Theorem I.21**, **Theorem I.23** and **Exercises I.33 2** so $-1 = x^2 < 0$. But $x^2 > 0$ by **Theorem I.20** where this is a contradiction by **Theorem I.16** 
...
$$\begin{split}
  ...
  & \Longrightarrow -a - b \in \mathbb{R} & \text{ Theorem I.3} \\
  & \Longrightarrow -(a + b) \in \mathbb{R} & \text{ Exercises I.33 5} \\
  & \Longrightarrow -(a + b) > 0 & \text{ By definition} \\
  & \Longrightarrow -(-(a + b)) < 0 & \text{ Theorem I.23, Exercises I.33 2} \\
...
$$\begin{split}
  ...
  & \Longrightarrow 0 < b^{-1} < a^{-1} & \text{ Exercises I.35 4} \\
  \end{split}$$
